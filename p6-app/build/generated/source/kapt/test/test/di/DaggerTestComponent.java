...
public final class DaggerTestComponent {
  ...
  private static final class TestComponentImpl implements TestComponent {
    ...
    private void initialize(final MessageApiComponent messageApiComponentParam,
      ...
      this.windowStateImpProvider = WindowStateImp_Factory.create(WbContainerProvider, WorkbookStateContMsProvider, StatusBarStateMsProvider, workbookStateFactoryProvider, WindowStateModuleForTest_Companion_FocusStateMsFactory.create(), FormulaColorProvider);
    ...
    private void initialize2(final MessageApiComponent messageApiComponentParam,
      ...
      this.windowActionImpProvider = DoubleCheck.provider(WindowActionImp_Factory.create(applicationScopeProvider, ((Provider) closeWorkbookActionImpProvider), SubAppStateContainerMsProvider, ((Provider) createNewWorkbookActionImpProvider), ((Provider) saveWorkbookActionImpProvider), ((Provider) loadWorkbookActionImpProvider), ((Provider) setActiveWindowActionImpProvider), ((Provider) closeWindowActionImpProvider), ((Provider) makeSavePathImpProvider)));
