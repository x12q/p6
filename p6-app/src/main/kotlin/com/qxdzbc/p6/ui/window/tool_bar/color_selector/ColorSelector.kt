...
internal val defaultColorList = listOf(
    Color.Black, Color(67,67,67),Color(102,102,102), Color(153,153,153),Color(183,183,183),Color(204,204,204),Color(217,217,217),Color(239,239,239),Color(243,243,243),Color.White,

    Color(153,40,27),Color(239,68,48),Color(245,153,48),Color(252,239,45),Color(117,233,21),Color(104,248,252),Color(74,134,232),Color(50,103,252),Color(161,111,253),Color(234,120,254)
)
@Composable
fun ColorSelector(
    windowId: String,
