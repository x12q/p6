 ...
 */
@ContributesBinding(WsAnvilScope::class, boundType = LimitedSlider::class)
@LimitedSliderQualifier
data class LimitedSliderImp @Inject constructor(
...
//    }
    ...
    companion object{
        fun forPreview(): LimitedSliderImp {
