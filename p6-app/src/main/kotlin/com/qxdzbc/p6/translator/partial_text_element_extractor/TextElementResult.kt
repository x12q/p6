...
data class TextElementResult(
    ...
    val allWithErrSorted: List<TextElement>
        get() {
    ...
    fun flattenToBasicTextOrErr(): TextElementResult {
        val rt = flattenToBasicTextOrNull() ?: TextElementResult(errs = this.errs)
        return rt
    }
    ...
    fun moveFerriedElementsToBasicTexts(): TextElementResult {
        var newBasicText = basicTexts
        if (ferryBasicTextElement != null) {
            newBasicText = newBasicText + ferryBasicTextElement
        }

        if (ferryWbElement != null) {
            newBasicText = newBasicText + ferryWbElement.toBasicTextElement()
        }
        if (ferryWsNameElement != null) {
            newBasicText = newBasicText + ferryWsNameElement.toBasicTextElement()
        }
        return this.copy(
            basicTexts = newBasicText
        )
    }
