package com.emeraldblast.p6.ui.script_editor.script_tree.state
...
class TreeNodeStateContainerImpTest {
    ...
    fun b() {
       testSample = TestSample()
        wbContainerMs = testSample.appState.globalWbContMs
...
//        assertNotNull(cont.getWbNodeStateMs(wbk2))
    ...
    fun replaceWorkbookKey() {
        ...
        testSample.appState.globalWbStateCont = testSample.appState.globalWbStateCont.replaceKey(oldWbk,newWbk)
