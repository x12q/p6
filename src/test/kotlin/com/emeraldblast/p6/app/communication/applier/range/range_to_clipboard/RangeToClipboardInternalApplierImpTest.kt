package com.emeraldblast.p6.app.communication.applier.range.range_to_clipboard

import com.emeraldblast.p6.app.action.range.range_to_clipboard.applier.RangeToClipboardInternalApplierImp
...
class RangeToClipboardInternalApplierImpTest {
    ...
    private val cursorState: CursorState
        get()= appState
        .getWorkbookState(TestSample.wbk1)
