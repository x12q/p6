package com.emeraldblast.p6.ui.document.worksheet.resize_bar
...
data class ResizeBarStateImp(
    ...
    override val selectableAreaWidth: Int = R.size.value.resizerThickness,
    override val isShow: Boolean = false,
    override val isActive: Boolean = false,
    override val thickness: Int = R.size.value.defaultResizeCursorThickness,
