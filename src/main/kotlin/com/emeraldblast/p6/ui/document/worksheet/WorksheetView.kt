package com.emeraldblast.p6.ui.document.worksheet
...
import com.emeraldblast.p6.ui.document.worksheet.ruler.Ruler
                ...
                Row {
                    BorderBox( // x: cell/range indicator
                        ...
                        modifier = Modifier.size(
                            DpSize(
                                R.size.value.rowRulerWidth.dp,
                                R.size.value.defaultRowHeight.dp
                            )
                        )
                    ) {
                        Text(
                    ...
                    MBox {
                        ...
                        Ruler(
                            ...
                            size = R.size.value.defaultRowHeight
                        )
                    }
                }
                Row {
                    MBox {
                        ...
                        Ruler(
                            ...
                            size = R.size.value.rowRulerWidth
                        )
                    }
                    MBox(
                        modifier = Modifier
